...
int main(void) {
  rtc::ByteBufferTest_TestByteOrder();
  rtc::ByteBufferTest_TestBufferLength();
  rtc::ByteBufferTest_TestGetSetReadPosition();
  rtc::ByteBufferTest_TestReadWriteBuffer();
  return 0;
}
